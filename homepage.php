						...
						<div class="col-md-9 col-sm-12 col-xs-12 pull-right">
							<div class="collapse navbar-collapse nav-collapse" id="fixed-collapse-navbar">
								<ul class="nav navbar-nav cl-effect-1">
									...
									<li><a href="quicktest.php" data-hover="Self-test">Self-test</a> </li>
								</ul>
	...
	<section id="translation-steps">
		<div class="container">
			<div class="row text-center steps-heading">
				<h1>Your Personal Health Care Centre  !</h1>
				<p>The Most Trusted Medical Services When You Need</p>				
			</div>
			<div class="row">
				<div class="steps-container">
					<div class="col-sm-3 text-center step">
						<span class="wow flipInY" data-wow-duration="1s"><i class="fa fa-heartbeat"></i></span>
						<p><a href="http://127.0.0.1:8000/">Glucose Manager</a></p>
